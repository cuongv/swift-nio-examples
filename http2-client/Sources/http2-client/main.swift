...
clientConfig.applicationProtocols = NIOHTTP2SupportedALPNProtocols
...
//let str = "https://httpbin.org"
let str = "https://localhost:9090"
let urls = [URL(string: str)!]//args.compactMap(URL.init(string:))
